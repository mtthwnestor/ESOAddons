...
SafeAddString(SI_BINDING_NAME_VOTANS_TOGGLE_MAP_SHOW_HUD, "Показать мини-карту")
SafeAddString(SI_BINDING_NAME_VOTANS_TOGGLE_MAP_SHOW_SIEGE_HUD, "Показать мини-карту")
SafeAddString(SI_BINDING_NAME_VOTANS_TOGGLE_MAP_SHOW_COMBAT, "Показать мини-карту в бою")
...
SafeAddString(SI_VOTANSMINIMAP_WORLD_MAP_TWEAKS_TOOLTIP, "Включает настройки распределения нагрузки на CPU с течением времени.")
...
SafeAddString(SI_VOTANSMINIMAP_SHOW_FREEZE_WARNING, "Предупреждения о фризах")
