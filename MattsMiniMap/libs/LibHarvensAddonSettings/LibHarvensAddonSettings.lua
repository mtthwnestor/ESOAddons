local version = 10704
LibHarvensAddonSettings = LibStub and LibStub:NewLibrary("LibHarvensAddonSettings-1.0", version)
if LibStub and not LibHarvensAddonSettings then return end
LibHarvensAddonSettings = LibHarvensAddonSettings or {}
